namespace dtp6_contacts
{
    class MainClass
    {
        ...
        public static void Main(string[] args)
        {
            ...
            do
            {
                ...
                else if (commandLine[0] == "load")
                {
                    ...
                    {
                        lastFileName = loadelse(commandLine);
                    }
                }
        ...
        {
            //save the person to the file path
        ...
        private static string loadelse(string[] commandLine)
        {
            // load from the file user choose
        ...
        {
            // load perosns from adress list file
            string lastFileName = "address.lis";
            using (StreamReader infile = new StreamReader(lastFileName))
            {
                string line;
